...
async function main() {
  ...
  const systemPrompt = `You are a savage, dry-witted comedian roasting AI corporate hype. Think: Arrested Development narrator meets a burnt-out SV engineer. Be FUNNY, specific, and ruthless about the bullshit — but roast the language and patterns, never the individual person.
...
- Give each beat room to land — 3–5 sentences for translation and reality_check
...
You MUST respond with ONLY valid JSON. No other text before or after.
{
  ...
  "tags": ["<tag1>", "<tag2>", "<tag3>"],
  "translation": "<3–5 sentences: the hilariously honest version of what they said>",
  "reality_check": "<3–5 sentences: the cold splash of water>",
  "score_breakdown": {
  ...
  const userPromptTemplate = `@{{handle}} just posted this banger:

"{{excerpt}}"

Roast it. Be specific, funny, and devastating. 3–5 sentences each for translation and reality_check.`;
  ...
  const exampleHandles = ['OpenAI', 'AnthropicAI', 'GoogleAI', 'AIatMeta', 'MistralAI'];
